...
import { Plus, Minus, Tag, ArrowLeft } from 'lucide-react';
          ...
          >
            ...
            <motion.div variants={staggerItem} className="flex flex-col sm:flex-row gap-4">
              <a
                ...
                className="flex-grow flex items-center justify-center gap-2 py-4 rounded-xl font-bold transition-all shadow-lg bg-[#25D366] text-white hover:bg-[#20ba5a] shadow-emerald-100 hover:scale-[1.02] active:scale-95 duration-200"
              >
              ...
              <Link
                href="/products"
                className="flex items-center justify-center gap-2 py-4 px-6 rounded-xl font-bold bg-white border border-gray-200 text-charcoal hover:bg-gray-100 hover:scale-[1.01] transition-all duration-200"
              >
                Kembali ke Katalog
              </Link>
            </motion.div>
