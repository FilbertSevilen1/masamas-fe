...
export default function WhatsAppFloatingButton() {
  ...
  return (
    <a
      ...
      style={{
        transition: 'transform 0.2s ease, background-color 0.2s ease, scale 0.2s ease',
      }}
      className="fixed bottom-6 right-6 z-[9999] flex items-center justify-center bg-[#25D366] text-white p-4 rounded-full shadow-2xl hover:bg-[#20ba5a] hover:scale-110 active:scale-95 group select-none cursor-pointer"
